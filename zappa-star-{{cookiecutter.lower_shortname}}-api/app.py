...
import gollyx_nongo
from gollyx_nongo.game_getter import StarIIGameGetter
from gollyx_nongo.team_getter import TeamsGetter
from gollyx_nongo.postseason_getter import (
    StarIIPostseasonPrecedingDayGetter,
    StarIIPostseasonDayGetter,
    StarIIPostseasonLengthGetter,
    StarIIPostseasonGetter,
)
from gollyx_nongo.seed_getter import (
    StarIISeedGetter,
)
from gollyx_nongo.season_getter import (
    StarIISeasonDayGetter,
    StarIISeasonPrecedingDayGetter,
    StarIISeasonGetter,
)
...
def setup_routes(app):
    ...
    def current_games():
        ...
        if mode < 0:
            ...
            sdg = StarIISeasonDayGetter(datadir, season0, day0)
            ...
            if mode==21:
                ...
                raise APIError()
            getter = StarIIPostseasonDayGetter(datadir, season0, series, 1)
            ...
            getter = StarIIPostseasonDayGetter(datadir, season0, series, series_day)
            games = getter.get_postseason_day_game_data_slim()
            games.sort(key=lambda x: x["description"])
    ...
    def games(season0, day0):
        ...
        if season0 < current_season0:
            ...
            dg = StarIISeasonDayGetter(datadir, season0, day0)
    ...
    def game(gameid, event=None, context=None):
        gg = StarIIGameGetter(datadir, gameid)
    ...
    def a_season(season0):
        ...
        if season0 < current_season0:
            ...
            sg = StarIISeasonGetter(datadir, season0)
            ...
            if mode < 10:
                ...
                spd = StarIISeasonPrecedingDayGetter(datadir, season0, day0)
    ...
    def a_postseason(season0):
        ...
        if season0 < current_season0:
            ...
            pg = StarIIPostseasonGetter(datadir, season0)
            ...
            if mode < 20:
                ...
                if mode == 21:
                    ...
                    raise FlaskError()
                ppdg = StarIIPostseasonPrecedingDayGetter(datadir, season0, series, 1)
                ...
                ppdg = StarIIPostseasonPrecedingDayGetter(
                ...
                pdg = StarIIPostseasonGetter(datadir, season0)
    ...
    def a_seeds(season0):
        ...
        if season0 < current_season0:
            ...
            sg = StarIISeedGetter(datadir, season0)
    ...
    @app.route("/champion")
    def champion():
        """Returns the Star II Cup champion for the current season that just ended, otherwise return nothing"""
        t = Timekeeper()
        season0 = t.get_current_season()
    ...
    def a_champion(season0):
        ...
        if season0 < current_season0:
            ...
            cg = StarIIChampionGetter(datadir, season0)
    ...
    def a_records(season0):
        ...
        if season0 < current_season0:
            ...
            rg = StarIIRecordsGetter(datadir, season0)
            ...
            if mode > 10 and mode < 30:
                ...
                # (for mode 21)
                rg = StarIIRecordsGetter(datadir, season0, current_day0 + 1)
                wlrecords = rg.get_records_data(use_abbr=False)
                return jsonify(wlrecords)
            else:
                rg = StarIIRecordsGetter(datadir, season0, current_day0)
                wlrecords = rg.get_records_data(use_abbr=False)
                return jsonify(wlrecords)
...
class Timekeeper(object):
    ...
    def prepare_current_season_marker_pool(self):
        ...
        # Postseason starts 24 hours after season ends
        self.postseason_start = self.season_start + timedelta(hours=one_day)
        ...
        self.postseason_lcs_start = self.postseason_start + timedelta(hours=6)
        ...
        # Star Cup (SCS) ends 1 hour after last game
    ...
    def get_postseason_series_length(self, season0, series):
        getter = StarIIPostseasonLengthGetter(datadir, season0, series)
